...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-24">
      {/* Background image (already has the Summers Cleaning logo imprinted) */}
      <div className="absolute inset-0 -z-10">
        ...
        />
        {/* Light text-readability wash — keep the image's color and personality */}
        ...
        <div className="absolute inset-0 bg-[radial-gradient(70%_55%_at_25%_30%,rgba(255,255,255,0.55),transparent_70%)]" />
      </div>

      {/* Decorative aqua + gold accents */}
      <div className="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-brand-aqua/25 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 -right-10 h-72 w-72 rounded-full bg-brand-gold/20 blur-3xl" />
        ...
        <div className="max-w-2xl">
          ...
          <h1 className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.05] text-brand-navy">
            ...
            <span className="relative inline-block">
              ...
              <span className="absolute inset-x-0 bottom-1 h-3 bg-brand-gold/50 -z-0 rounded-sm" />
            </span>{" "}
            in Charleston, SC
          </h1>

          <p className="mt-5 text-lg text-brand-navy/85 max-w-xl leading-relaxed">
            Hi, I&apos;m{" "}
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a href={`tel:${site.phoneTel}`} className="btn-outline bg-white/90 backdrop-blur-sm">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <div className="inline-flex items-center gap-2.5 rounded-full bg-white/95 backdrop-blur-sm px-4 py-2 ring-1 ring-brand-aqua/30 shadow-card">
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-brand-aquaMist text-brand-aquaDeep">
            ...
            <div className="inline-flex items-center gap-2.5 rounded-full bg-white/95 backdrop-blur-sm px-4 py-2 ring-1 ring-brand-gold/40 shadow-card">
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-brand-gold/25 text-amber-700">
                <PawIcon className="h-3.5 w-3.5" />
              </span>
              <span className="text-sm font-bold text-brand-navy">Pet-Friendly</span>
            </div>

            <div className="inline-flex items-center gap-2.5 rounded-full bg-brand-gold px-4 py-2 ring-1 ring-brand-gold shadow-gold">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-6 text-sm">
            ...
            <div className="flex items-center gap-2 text-brand-navy/85">
